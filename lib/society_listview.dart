                     ...
                     onTap: (){
                       ...
                       shape: RoundedRectangleBorder(
                         borderRadius: BorderRadius.vertical(bottom: Radius.circular(20),top:Radius.circular(20) )),
                             ...
                             child: Container(
                                  ...
                                  AssetImage('${AppState.societydetail[index].society_image}',
                      ...
                      borderRadius: BorderRadius.all(Radius.circular(21))
                                   ...
                                   child: ListTile(
                                     ...
                                     title: Text('${AppState.societydetail[index].society_name}',
                                     textAlign: TextAlign.left,
                                     
                                style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,decoration: TextDecoration.underline),),
                               ),
                                 ),
                                 ),  
